...
namespace gts
{
    public class mc
    {
        ...
        [DllImport("gts.dll")]
        public static extern short GT_EncOn(short cardNum,short encoder);//设置外部编码器
        [DllImport("gts.dll")]
        public static extern short GT_EncOff(short cardNum,short encoder);//设置内部脉冲计数器
        [DllImport("gts.dll")]
        ...
        [DllImport("gts.dll")]
        public static extern short GT_SetJogPrm(short cardNum,short profile,ref TJogPrm pPrm);//ref，引用：外面可以改
        [DllImport("gts.dll")]
        public static extern short GT_GetJogPrm(short cardNum,short profile,out TJogPrm pPrm);//out，引用：只能传出来，不能改
